    ...
    return (
        <header className="App-header">
            ...
            <h3 className={styles.startContainer}>
                ...
                <a href={logged ? "/#/home" : "/#/login"} className={styles.link} style={{width: "50%", display: "flex", justifyContent:"right", marginRight:"50px", textDecoration:"none"}}>{logged? "start trading" : "log in"}</a>
