# -*- coding: utf-8 -*-
"""barterly_recommendation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/10qFZFusi2-j-oTIRiJHGbgbmA-Rrih5e

## barterly recommendation system
based on a user's previous trades, we recommend items for future transactions
"""
...
df_dists = pd.read_csv(path + "/distances.csv", index_col=False)

# print csv column names to check
print(df_prods.columns.values)
print(df_trans.columns.values)
print(df_dists.columns.values)
