    ...
    return (
        <header className="App-header">
            ...
            <h3 className={styles.startContainer}>
                ...
                <a href={isLogged ? "/#/home" : "/#/login"} className={styles.link} style={{width: "50%", display: "flex", justifyContent:"right", marginRight:"50px", textDecoration:"none"}}>start trading</a>
                <a href={isLogged ? "/#/home" : "/#/login"} className={styles.fancyArrow} style={{ width: "50%", height: "100%" }}>
